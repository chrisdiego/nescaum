...
const DescriptionWithPhotoSideBySide = ({ 
	...
	const [ colorScheme, setColorScheme ] = useState({ bgcolor: '#003354', color: 'white' });
	...
	return (
		<Container {...{ bgColor, inverse, nullBorderBottom }} className='DescriptionWithPhotoSideBySide'>
			<CenterContainer>
				<TextContainer {...{ inverse }}>
					...
					{href && (
						<ArrowWithBox color={ color } href={ href } openNewTab={external}/>
					)}
...
const Container = styled.div`
	...
	border-bottom: ${ props => props.nullBorderBottom ? 0 : '5px solid white'};
