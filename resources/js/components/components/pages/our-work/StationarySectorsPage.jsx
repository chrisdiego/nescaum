...
const StationarySectorsPage = () => {
  return (
    <> 
      <PageScaffold 
        heroImage="/images/smokestack-pexels.jpg"
        headline="Stationary Sectors"
        sideImage="/images/street-smoke.jpg"
...
const subArticles = [
  {
    ...
    imageSrc: '/images/paperwork-pexels.jpg', 
    href: '#' 
  },
  {
  ...
  },
  {
    ...
    imageSrc: '/images/boiler-pexels.jpg', 
  },
  {
    title: 'Wood heating', 
