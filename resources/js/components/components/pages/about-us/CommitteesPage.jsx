...
const CommitteesPage = () => {
    ...
    return (
        ...
        {pages["aboutUs"].committees.committees.map((committee, i) => {
            return (
                <Accordion.Item eventKey={i}>
                <Accordion.Header>{committee.title}</Accordion.Header>
                <Accordion.Body>
                {committee.desc}
                {committee.list?.map(sub => <li><b>{sub.title}:</b><br />{sub.desc}</li>)}
                </Accordion.Body>
            </Accordion.Item>
            )
        })}
